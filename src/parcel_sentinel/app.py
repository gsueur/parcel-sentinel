...
from .routes import customers, features, health, parcels, report, score, thumbnail, timeseries
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="Parcel Sentinel Analytics API",
        version="0.1.0",
        lifespan=lifespan,
    )
    ...
    app.include_router(parcels.router, prefix="/v1")
